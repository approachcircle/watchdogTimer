...
os.system("queryExist.bat")  # since i wanna be fancy and use multi language files, im gonna just execute this in a
# separate batch file instead of just doing it here inline
