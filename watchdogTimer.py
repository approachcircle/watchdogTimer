...
try:
    ...
    print("A fatal error occurred and the program needs immediate attention.")
    ...
    print("TRACEBACK BUGCHECK")
    print("A fatal error occurred and the program needs to restart in order to continue operation.")
    print()
